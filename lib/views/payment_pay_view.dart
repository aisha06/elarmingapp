      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child:ListTile(
              leading: Image.asset(
                  "assets/images/phonepe-logo-icon 2.png"),
              title: Text("Phone pe",style: TextStyle(fontWeight: FontWeight.bold),),
            )
          ),
          Container(
            margin: EdgeInsets.only(left: 20.0,top: 40.0),
            child: Align(alignment: Alignment.topLeft,
                child: Text("+Add New Method",style: TextStyle(
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text("45,000 ",style: TextStyle(
                            fontWeight: FontWeight.bold,fontSize:16.0),
                        ),
                      ),
                    ],
